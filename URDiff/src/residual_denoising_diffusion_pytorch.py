...
from .utils import *
from .residual_diff import ResidualDiffusion
...
class Trainer(object):
    ...
    def test(self, last=True):
        ...
        for data in loader:
            ...
            # utils.save_image(all_images_list[2], str('./' + file_name))
            ...
            if self.is_dunhuang:
                utils.save_image(x_input_sample[4], str('./results/Mask-DH/' + file_name))
                ...
                utils.save_image(x_input_sample[4], str('./results/Mask-TEN/' + file_name))
                utils.save_image(all_images_list[-1], str('./results/Ours-TEN/' + file_name))
                utils.save_image(all_images_list[0], str('./results/GT-TEN/' + file_name))
                utils.save_image(all_images_list[1], str('./results/Input-TEN/' + file_name))
